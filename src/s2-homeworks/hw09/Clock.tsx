...
function Clock() {
    ...
    //console.log(timerId) //смотрим, очистился ли timerId
    ...
    const onMouseEnter = () => { // пишут студенты // показать дату если наведена мышка
        setShow(true) //почему нет currentTarget.value?
    }
...
/*    let timeFormatter = Intl.DateTimeFormat("ru", {hour: "numeric",
    minute:"numeric"})*/
    ...
    let dayFormatter = Intl.DateTimeFormat("en-US", {weekday: "long"})
    const stringDay = dayFormatter.format(date) || <br/> // пишут студенты

    let monthFormatter = Intl.DateTimeFormat("en-US", {month: "long"})
